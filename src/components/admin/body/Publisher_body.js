        ...
        <div className="statistics">
          <div className="total_reporters">
            ...
            >
              ...
              <p style={{ color: "#f3f5f9" }}>Total Publishers</p>
            </div>
            <div>
